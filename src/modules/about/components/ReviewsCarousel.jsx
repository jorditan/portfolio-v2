    ...
    <div className="relative flex w-full flex-col gap-4">
        ...
        {reviews.map((review, index) => {
          ...
          return (
            <article
              ...
              className={`${reducedMotion.current ? "" : "transition-all duration-500 ease-out"} ${isActive
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <small className="text-gray-700 dark:text-gray-300">Trajamos juntos en: {review.job}</small>
                      </div>
                    </div>
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            <svg suppressHydrationWarning xmlns="http://www.w3.org/2000/svg" width={16} height={16} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
