      ...
      <div id={id} className="relative w-full">
        <div className="relative overflow-hidden  w-64 h-64 rounded-md">
          {photos.map((photo, idx) => (
            <div
              key={photo.src}
              className={`duration-700 h-full ease-in-out ${idx === current ? "block" : "hidden"}`}
            >
              <img
        ...
        >
          <span className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-white/30 dark:bg-gray-900/40 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-4 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none">
