...
const FigmaIcon = () => (
  <svg width="12" height="12" viewBox="0 0 54 80" fill="none">
...
const EyeIcon = () => (
  <svg height="22px" width="22px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
...
const designProjects = [
  {
    image: "/film_information.webp",
    alt: "Letterboxd redesign",
    title: "Letterboxd redesign",
    description:
      "Proyecto realizado en el curso de diseño UX/UI avanzado de Coderhouse en donde se aplican diversos métodos de research, diseño de wireframes y prototipado.",
    tags: [
    ...
    url: "https://www.behance.net/gallery/208245225/Letterboxd-redesign-Case-of-study-UXUI",
  },
  {
    image: "/test_phishing.webp",
    alt: "Test phishing Hackmetrix",
    title: "Test de phishing",
    description: (
      <>
        Proyecto realizado para{" "}
        <a target="_blank" className="underline text-sky-500" href="https://www.hackmetrix.com">
          Hackmetrix
        </a>
        . Su objetivo es concientizar a los usuarios sobre el phishing y
        capacitarlos con consejos profesionales.
      </>
    ),
    tags: [
      { icon: <FigmaIcon />, text: "Figma" },
    ...
    url: "https://test-phishing.hackmetrix.com/",
  },
  {
    image: "/redesign_legales.webp",
    alt: "Diseño módulo de legales",
    title: "Diseño módulo de legales",
    description: (
      <>
        Proyecto realizado para{" "}
        <a target="_blank" className="underline text-sky-500" href="https://www.hackmetrix.com">
        ...
        . Realización de entrevistas contextuales con sus respectivos reportes.
        Aprendizajes a nivel de diseño de producto.
      </>
    ),
    tags: [
      { icon: <FigmaIcon />, text: "Figma" },
          ...
          <div className="max-w-sm dark:border bg-gray-100 border-2 border-gray-700 rounded-lg shadow dark:bg-gray-800">
            ...
            <div className="p-5 flex flex-col gap-3">
              ...
              <div className="flex justify-end w-full gap-4">
                <LinkButton href={project.url} className="w-fit">
                  <EyeIcon />
                  Ver proyecto
                </LinkButton>
              </div>
