      ...
      {isOpen && (
        <div className="h-[100%] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center bg-[#282828c6] items-center w-full md:inset-0 max-h-full flex shadow-lg">
          <div className="relative p-4 w-full max-w-2xl max-h-full">
            <div className="relative rounded-lg shadow-sm bg-slate-50 border border-gray-700 dark:bg-gray-900">
              <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-900">
                ...
                <button
                  ...
                  className="text-slate-50 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center border border-gray-700 dark:bg-gray-800 hover:bg-gray-800 bg-gray-700 dark:hover:text-white"
                >
                  ✕
                </button>
              </div>
