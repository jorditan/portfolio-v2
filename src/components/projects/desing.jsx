      ...
      <div className="max-w-sm bg-[#28282830] border border-gray-700 rounded-lg shadow dark:bg-gray-800">
        ...
        <div className="p-5 flex flex-col gap-3">
          ...
          <p className="font-normal text-gray-300">
            Proyecto realizado como proyecto integrador del curso de diseño UX/UI avanzado de Coderhouse.
          </p>
          <div className="flex flex-wrap">
            <span className="bg-[#28282834] badge gap-1 text-[#fafafa] text-[10px] font-medium inline-flex items-center px-1.5 rounded me-2 dark:bg-gray-700 dark:text-gray-400 border border-gray-500 transition-all">
