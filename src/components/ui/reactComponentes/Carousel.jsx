function MyCarousel() {
  return (
    ...
    <div className="dark:shadow-gray-800 transition-transform duration-300 hover:rotate-2 ring-2 ring-gray-800 dark:ring-gray-50 p-2 rounded-lg">
      <div id="controls-carousel" class="relative w-full transition-transform duration-300" data-carousel="static">
        <div class="relative overflow-hidden w-64 h-64 object-cover object-top rounded-md transition-transform ">
          <div class="hidden duration-700 ease-in-out" data-carousel-item="active">
            <img class=" rounded-lg object-cover object-top " src="/foto-campo.webp" alt="Foto con una cámara de fotos en Entre Rios" />
          </div>
          <div class="hidden duration-700 ease-in-out " data-carousel-item>
            <img class="rounded-lg object-cover object-top" src="/foto-slack.webp" alt="Primera foto en mucho tiempo" />
          </div>
          <div class="hidden duration-700 ease-in-out " data-carousel-item>
            <img class="rounded-lg  object-center" src="/foto-merendando.webp" alt="Foto merendando" />
          </div>
        </div>
